...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "nimeshhasaranga02@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+94 77 000 0000",
  },
];
...
const Contact = () => {
  return (
    <div className="relative -bottom-15 -mt-15 z-10 px-2">
      <div
        className="content p-4 md:p-10 lg:p-22 bg-base-100 rounded-2xl shadow-[0px_0px_90px_9px_rgba(0,_0,_0,_0.1)]"
        id="contact"
      >
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          <div>
            <div>
              <p className="text-[35px] max-lg:hidden font-semibold text-nowrap text-base-content">
          ...
          <div className="w-full overflow-y-scroll py-6.5">
            <p className="text-xl mb-2 xs:text-2xl sm:text-2xl md:text-[38px] font-semibold text-base-content lg:hidden text-center">
              Let’s discuss your Project
            </p>
            <Form />
          </div>
